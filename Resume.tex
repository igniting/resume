...
\begin{itemize}
\setlength{\itemsep}{0.1mm}
	\item Replace the hard-coded constants in MySQL server optimizer with self tuning coefficients, resulting into better query plans
	\item It involved understanding MySQL server internals, coding in C++, version control using git, building a project using cmake
\end{itemize}
...
\setlength{\itemsep}{0.1mm}
	...
	\item It involved working with large scale distributed systems that stand at foundation of Facebook infrastructure, advanced python coding, git, MySQL etc.
\end{itemize}
...
\begin{itemize}
\setlength{\itemsep}{0.1mm}
	\item Design a web application to bring all the activities involving logistics and information organization at a central place
...
\begin{itemize}
\setlength{\itemsep}{0.1mm}
\item \textbf{Structure from Motion}: Estimate 3-D structures from 2-D image sequences coupled with local motion signals
